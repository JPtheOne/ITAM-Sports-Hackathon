...
1. Clona este repositorio y navega hasta el directorio principal:

    ```bash
    git clone https://github.com/tuusuario/ItamSportsHackathon2024.git
    cd ItamSportsHackathon2024
    ```
